...
Client::Client()
{
	...
	ss << str << "\\..\\";
	m_DataPath = ss.str();
	m_SoundDataFileName = "SceneLua_sound.xml";
	m_ShaderDataFileName = "SceneLua_shader.xml";
	m_TextureDataFileName = "SceneLua_texture.xml";
	m_MeshDataFileName = "SceneLua_mesh.xml";
}
...
void Client::Destroy()
{
	...
	SafeDestroy(LuaBrain::GetInstance());
	SafeDestroy(CommandManager::GetInstance());
